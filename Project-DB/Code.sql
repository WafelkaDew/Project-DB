...
(DEFAULT, 'Алексей Смирнов', 'Al@example.com', 2021),
(DEFAULT, 'Елена Кузнецова', 'El@example.com', 2022),
(DEFAULT, 'Дмитрий Новиков', 'Dmit@example.com', 2021),
(DEFAULT, 'Ольга Морозова', 'Ol@example.com', 2023);
